...
// realistic-looking data: app/js/debug.js used to have a
...
//
// The three stats sections (see index.html / ui/stats.js) each read from a
// different source, so each needs deliberately varied fixture data to
...
test.describe("stats dialog with representative history", () => {
	test("renders word list, counting stats, and histogram for a realistic mix of past games", async ({
		...
		// wordsProvided.length > 0 branch in app/js/ui/view.js's handleGameStarted.
