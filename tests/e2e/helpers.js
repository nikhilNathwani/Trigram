...
// That's not just style: public/js's game/view state (trigram, wordList,
...
// more robust anyway (see tests/TESTING-GUIDE.md §7's "prefer public, observable
...
// (`animationend` in public/js/ui/modal.js), not a fixed delay, so we wait on
...
// TrigramRevealOverlay.astro's <style> block, and a shorter guessed wait
// silently ate every keystroke
...
// setTrigramHeader() in public/js/ui/view.js. Waiting on this is a black-box
